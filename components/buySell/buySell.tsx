  ...
  return (
    <div className=" buy&sell ">
      <div className=" header flex justify-between ">
        <div className=" bg-[#1d2430] rounded-[5px] p-1.5 ">
          <svg
      ...
      <div>
        <div className=" flex gap-2.5 my-2.5 ">
          <p className=" p-1.5 rounded-2xl bg-[#11161d] text-[#ffffff99] border border-[#ffffff0d] cursor-pointer text-[12px] leading-none ">
            {" "}
            Fixed price{" "}
          </p>
          <p className=" p-1.5 rounded-2xl bg-[#11161d] text-[#ffffff99] border border-[#ffffff0d] cursor-pointer text-[12px] leading-none ">
          ...
          <div className=" basis-1/2 ">
            <div>
              <InputGroup className=" bg-[#1d2430] ">
                ...
                <InputGroupAddon
                  align="inline-end"
                  className=" text-[12px] border-l border-[#ffffff0d] pl-2.5 h-fit w-16 "
                >
                  Price
                </InputGroupAddon>
              </InputGroup>
            ...
            <div className=" mt-2.5 ">
              <InputGroup className=" bg-[#1d2430] ">
                ...
                <InputGroupAddon
                  align="inline-end"
                  className=" text-[12px] border-l border-[#ffffff0d] pl-2.5 w-16"
                >
                  Amount
                </InputGroupAddon>
              </InputGroup>
              ...
              <div className="mx-auto grid w-full max-w-xs gap-3">
                <div className="flex items-center justify-between gap-2">
                    <div className=" flex items-center ">
                      ...
                      <p className=" text-[#ffffff66] text-[12px] "><span>{sell.join(", ")}</span> BTC</p>
                    </div>
                    <div className=" text-[#ffffff66] text-[12px] ">
                      Available
                    </div>
                </div>
                <Slider
            ...
            <div className=" mt-2.5 ">
              <div className=" flex justify-center items-center rounded-[10px] bg-[#1d2430] py-1 text-[#6D7074] font-bold text-[14px] "> SELL </div>
            </div>
          </div>
          <div className=" basis-1/2 ">
            <div>
              ...
              <div className="mx-auto grid w-full max-w-xs gap-3">
                <div className="flex items-center justify-between gap-2">
                    <div className=" flex items-center ">
                      ...
                      <p className=" text-[#ffffff66] text-[12px] "><span>{buy.join(", ")}</span> TMN</p>
                    </div>
                    <div className=" text-[#ffffff66] text-[12px] ">
                      Available
                    </div>
            ...
            <div className=" mt-2.5 ">
              <div className=" flex justify-center items-center rounded-[10px] bg-[#1d2430] py-1 text-[#6D7074] font-bold text-[14px] "> BUY </div>
            </div>
          </div>
        </div>
      </div>
